...
async def update_password(
    ...
    try:
        # Leer content-type y normalizar
        content_type = (request.headers.get("content-type") or "").lower()
        data = {"current_password": None, "new_password": None, "confirm_password": None}
        ...
        if "application/json" in content_type:
            ...
            data["confirm_password"] = (
                ...
                or payload.get("check_password")
                or payload.get("checkPassword")
            )
        else:
            # intentar form-data (x-www-form-urlencoded o multipart/form-data)
            try:
                ...
                data["confirm_password"] = (
                    ...
                    or form.get("confirmPassword")
                    or form.get("confirm")
                    or form.get("check_password")
                    or form.get("checkPassword")
                )
            except Exception:
        ...
        try:
            ...
            # Retornar errores Pydantic en 422 (estructura detallada)
            raise HTTPException(status_code=status.HTTP_422_UNPROCESSABLE_ENTITY, detail=e.errors())

        # Confirmar coincidencia de nuevas contraseñas
